//"DXUT.h"      // This is all you need if you use Visual Studio and the DirectX SDK

#include <float.h>     // Otherwise you may need these header files
#include <math.h>
// Note: It seems 'logb' works on this platform with this complier. However, '_logb'
// or 'std::logb' may work for others. (Paul Zhu)
#include <stdlib.h>
#include <string.h>
